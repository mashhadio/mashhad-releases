...
(function(){
  ...
  // Measured on 1.0.9 (everything but the .deb grew by about a megabyte).
  var FILES = {
    win:       { name: "Mashhad.exe",        size: "~102 م.ب", url: BASE + "/Mashhad.exe" },
    mac_arm64: { name: "Mashhad-arm64.dmg",  size: "~119 م.ب", url: BASE + "/Mashhad-arm64.dmg" },
    mac_x64:   { name: "Mashhad-x64.dmg",    size: "~132 م.ب", url: BASE + "/Mashhad-x64.dmg" },
    linux:     { name: "Mashhad.AppImage",   size: "~141 م.ب", url: BASE + "/Mashhad.AppImage" },
