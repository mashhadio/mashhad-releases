...
(function(){
  ...
  document.addEventListener("click", function(e){
    ...
    // The hero video plays inline, so no navigation ever marks it.
    var vid = el && el.closest ? el.closest("button.vid-play") : null;
    if(vid){ gtag("event", "video_play", { video_id: "L58wznVP6SI" }); }
  }, true);
})();
